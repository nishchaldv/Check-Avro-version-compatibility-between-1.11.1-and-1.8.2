//add data to avro file in 1.11.1 version to again add in 1.8.2 version to check compatibility between 1.8.2 and 1.11.1
...
public class  AddData{
   public static void main(String args[]) throws IOException{
      ...
      empFileWriter.create(e1.getSchema(), new File("/path/to/avrofiles/addingfrom1.11.1.avro"));
      ...
      empFileWriter.close();
      System.out.println("data successfully serialized from 1.11.1");
   }
}