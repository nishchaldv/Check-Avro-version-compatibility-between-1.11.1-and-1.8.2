...
public class SchemaEvolCheckin11_1from8_2 {
    public static void main(String[] args) throws IOException {
        // Load the Avro data file with the old schema
        File inputFile = new File("/path/to/avrofiles/avrofile_gen_from1_8_2_for_schema_check.avro");
        ...
        dataFileWriter.create(newSchema, new File("/path/to/avrofiles/modified_avrofile_gen_from1_11_1_for_schema_evol.avro"));
