//Serialize the data in 1.11.1 to deserialize in 1.11.1 version to check compatibility between 1.8.2 and 1.11.1
...
public class Serialize {
   public static void main(String args[]) throws IOException{
      ...
      empFileWriter.create(e1.getSchema(), new File("/path/to/avrofiles/serializedfilefrom1.11.1.avro"));
